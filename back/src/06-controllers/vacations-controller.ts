...
router.post("/vacations",VerifyLoggedInn, async (request: Request, response: Response, next: NextFunction) => {
    try {
...
router.put("/vacations/:id",VerifyLoggedInn, async (request: Request, response: Response, next: NextFunction) => {
    try {
        const id = +request.params.id;
        request.body.id = id;
        request.body.image = request.files?.image;
...
router.patch("/vacations/:id",VerifyLoggedInn, async (request: Request, response: Response, next: NextFunction) => {
    try {
        const id = +request.params.id;
...
//ראוט אשר מוחק מוצר
router.delete("/vacations/:id",VerifyLoggedInn, async (request: Request, response: Response, next: NextFunction) => {
    try {
        const id = +request.params.id;
