...
--
-- Host: 127.0.0.1
-- Generation Time: נובמבר 07, 2022 בזמן 11:12 AM
...
INSERT INTO `vacations` (`vacationId`, `Description`, `CreationDate`, `Name`, `Price`, `imageName`, `isFollow`) VALUES
...
(18, 'er', '2022-11-07 12:00:00', 'er4256', '33', 'aebfefbd-5f0e-4640-a389-260308a6e629.png', 0);
...
--
ALTER TABLE `vacations`
  MODIFY `vacationId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
